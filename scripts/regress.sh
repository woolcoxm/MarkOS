...
gates=(test-exceptions test-smp test-block test-fat test-pool test-matmul test-net test-control test-install test-soak test-pcie test-model test-forward test-gen test-gen-net test-gensoak test-sustain)
[ $# -gt 0 ] && gates=("$@")
