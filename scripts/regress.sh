...
gates=(test-exceptions test-smp test-block test-fat test-pool test-matmul test-net test-control test-install test-soak test-pcie test-model test-forward)
[ $# -gt 0 ] && gates=("$@")
